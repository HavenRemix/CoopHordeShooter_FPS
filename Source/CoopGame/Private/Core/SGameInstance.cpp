...
// ------- ONLINE - HOSTING A SESSION ------- \\


bool USGameInstance::HostSession(TSharedPtr<const FUniqueNetId> UserId, FName SessionName, bool bIsLAN, bool bIsPresence, int32 MaxNumPlayers)
{
...
// ------- ONLINE - FINDING A SESSION ------- \\


void USGameInstance::FindSessions(TSharedPtr<const FUniqueNetId> UserId, bool bIsLAN, bool bIsPresence)
{
...
// ------- ONLINE - JOINING A SESSION ------- \\


bool USGameInstance::JoinSession(TSharedPtr<const FUniqueNetId> UserId, FName SessionName, const FOnlineSessionSearchResult& SearchResult)
{
	// Return bool
...
void USGameInstance::FindOnlineGames()
{
...
void USGameInstance::JoinOnlineGame()
{
	ULocalPlayer* const Player = GetFirstGamePlayer();
